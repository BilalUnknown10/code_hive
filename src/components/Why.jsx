...
const Why = () => {
  ...
  return (
    ...
    //   </div>
    // </div>
    // <div ref={main} className="container h-screen mx-auto flex flex-col justify-center items-center text-2xl md:text-5xl text-white space-y-16">
    //   <div className="box">
    //     <h1 className="">Why you choose us?</h1>
    //   </div>
    //   <div className="box">
    //     <h1 className=" bg-gradient-to-r from-white to-blue-500 bg-clip-text text-transparent">
    //       Unrivaled Expertise
    //     </h1>
    //   </div>
    //   <div className="h-[50vh] box" >
    //     <h1 className=" bg-gradient-to-r from-white to-blue-500 bg-clip-text text-transparent">
    //       Customer-Centric Approach
    //     </h1>
    //   </div>
    //   <div
    //     className="h-[50vh] box">
    //     <h1 className=" bg-gradient-to-r from-white to-blue-500 bg-clip-text text-transparent">
    //       End-to-End Support
    //     </h1>
    //   </div>
